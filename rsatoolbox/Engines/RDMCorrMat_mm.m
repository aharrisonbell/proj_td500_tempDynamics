function corrMat=RDMCorrMat_mm(RDMs,figPlotSpec,type)
% USAGE
...
% mm: assume there're no missing dissimilarities = use corr on all RDMs
% simultaneously = much faster. Currently does not work for Kendall tau a. 
...
if isequal(type,'Kendall_taua')
    ...
    corrMat=corr(RDMs_cols,'type', type, 'rows', 'complete');
%     for RDMI1 = 1:nRDMs
%         for RDMI2 = 1 : nRDMs
