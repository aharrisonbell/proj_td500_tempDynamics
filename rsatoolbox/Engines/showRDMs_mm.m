function showRDMs_mm(RDMs,figI,rankTransform01,clims,showColorbar, aspect, imagelabels, colourScheme)
...
% mm: 
% (1) set colourScheme to RDMcolormap if not passed or empty (instead of
%     always setting the colourScheme to RDMcolormap, even if a different
%     colourScheme was passed).
% (2) do not display RDM type if RDM name is passed.
